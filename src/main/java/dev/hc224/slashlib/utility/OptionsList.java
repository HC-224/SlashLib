...
public class OptionsList {
    ...
    private final Interaction interaction; // Needed for attachments

    public OptionsList(List<ApplicationCommandInteractionOption> options, Interaction interaction) {
     ...
     *
     * @param name the name of the option to get
     * @return a non-empty {@link Mono}[{@link User}] if an option exists with the provided name *and* has a value
     */
     ...
     *
     * @param name the name of the option to get
     * @return a non-empty {@link Mono}[{@link Channel}] if an option exists with the provided name *and* has a value
     */
     ...
     *
     * @param name the name of the option to get
     * @return a non-empty {@link Mono}[{@link Role}] if an option exists with the provided name *and* has a value
     */
     ...
     *
     * @param name the name of the option to get
     * @return a non-empty {@link Optional}[{@link Double}] if an option exists with the provided name *and* has a value
     */
    ...
    /**
     * Get the value of the option with the specified name, for an Attachment option type.
     * This will go through the {@link ApplicationCommandInteraction} to fetch the attachment.
     *
     * @param name the name of the option to get
     * @return a non-empty {@link Optional}[{@link Attachment}] if an option exists with the provided name *and* has a value
     */
    public Optional<Attachment> getAttachment(String name) {
        return getOption(name)
            ...
            // The attachment option value is the Snowflake ID of the attachment
            .map(Snowflake::of)
            // Get the attachment from the resolved interaction
            .flatMap(snowflake -> interaction.getCommandInteraction()
                .flatMap(ApplicationCommandInteraction::getResolved)
                .flatMap(acir -> acir.getAttachment(snowflake)));
    }
}
